...
// server
MACRO_CONFIG_INT(SvWarmup, sv_warmup, 10, 0, 0, CFGFLAG_SERVER, "Number of seconds to do warmup before round starts")
...
MACRO_CONFIG_INT(SvHiderToSeekerSec, sv_hidetoseeker_sec, 45, 15, 600, CFGFLAG_SERVER, "The hider in jail, change to seeker seconds")
MACRO_CONFIG_INT(SvHiderFreezeSec, sv_hider_freeze_sec, 30, 10, 60, CFGFLAG_SERVER, "The hider freeze seconds")
